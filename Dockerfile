...
RUN wget https://download.geofabrik.de/north-america/us/ohio-latest.osm.pbf -O ./data/ohio-latest.osm.pbf
...
COPY --chown=ors:ors --from=build  /ors-core/data/ohio-latest.osm.pbf ${BASE_FOLDER}/tmp/osm_file.pbf
